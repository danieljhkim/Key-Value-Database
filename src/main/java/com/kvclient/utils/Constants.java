...
public class Constants {
    ...
    public static final String SQL_HELP_MESSAGE = "SQL Available commands: \n" +
            ...
            "3. SQL SET/INSERT key value - Insert a key-value pair.\n" +
            "4. SQL GET/SELECT key - Retrieve the value for a given key.\n" +
            "5. SQL DEL/DELETE key - Delete a key-value pair.\n" +
    ...
    public static final String KV_HELP_MESSAGE = "KV-Store Available commands: \n" +
            ...
            "7. ALL - Return all key-value pairs.\n" +
